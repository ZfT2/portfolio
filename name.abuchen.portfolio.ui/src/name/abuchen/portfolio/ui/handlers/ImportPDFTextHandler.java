...
import name.abuchen.portfolio.datatransfer.pdf.PDFTextImportAssistant;
...
public class ImportPDFTextHandler
{
    ...
    /* package */ void doExecute(MPart part, Shell shell)
    {
        ...
        fileDialog.setText(Messages.PDFImportDebugTextImport);
        fileDialog.setFilterNames(new String[] { Messages.PDFTextImportFilterName });
        ...
        try
        {
            IRunnableWithProgress operation = monitor -> {
                ...
                PDFTextImportAssistant assistent = new PDFTextImportAssistant(client, files);
